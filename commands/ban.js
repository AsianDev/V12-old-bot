...
exports.run = async(client, msg, args) => {
    if(!msg.member.hasPermission('BAN_MEMBERS')) return msg.reply('Hey M8 you dont have perms to do this, contact Limit if you want to be a staff!')
    ...
    if (member){
        if(member.hasPermission('MANAGE_MESSAGES')) return msg.reply('You cannot ban or ban fellow mods')
    }
    ...
    .setcolor('0x738adb')
    .setDescription(`You have been Banned by me or by my staff, you have 48 hours to send Limit an appeal to your Ban. Here is the reason that was provided for your Ban. Limit is always happy to send you another invite link: **${reason}**`)
    try {
